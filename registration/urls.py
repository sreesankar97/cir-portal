...
urlpatterns = [
    ...
    url(r'^portal/student/external/$', TemplateView.as_view(template_name='register/cirstaff/filter_external.html'),name="filter_external"),
    url(r'^student/filter/external/external_list/$', StudentFilterExternalView.as_view(), name="external_list")
